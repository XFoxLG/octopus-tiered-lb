...
var auditedManagementWriteRoutes = map[string]struct{}{
	...
	"POST /api/v1/model/price-category/create":                                       {},
	"POST /api/v1/model/price-category/update":                                       {},
	"POST /api/v1/model/price-category/delete":                                       {},
	"POST /api/v1/model/price-schedule/create":                                       {},
	"POST /api/v1/model/price-schedule/update":                                       {},
	"POST /api/v1/model/price-schedule/delete":                                       {},
