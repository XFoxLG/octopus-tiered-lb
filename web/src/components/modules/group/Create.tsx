        ...
        <div className="relative flex h-full min-h-0 w-full max-w-full flex-col">
            ...
            <MorphingDialogDescription className="relative flex-1 min-h-0 overflow-hidden">
                <GroupEditor
                    ...
                    onSubmit={({ name, category, endpoint_type, endpoint_provider, outbound_format, match_regex, condition, mode, first_token_time_out, attempt_time_out, stream_idle_timeout, session_keep_time, reasoning_buffer_strategy, default_reasoning_effort, reasoning_force_override, members }) => {
                        ...
                        createGroup.mutate(
                            {
                                ...
                                stream_idle_timeout: stream_idle_timeout ?? 0,
