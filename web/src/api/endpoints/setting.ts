...
export const SettingKey = {
    ...
    AuthErrorCooldown: 'auth_error_cooldown',
    ServerErrorCooldown: 'server_error_cooldown',
    RateLimitChannelThreshold: 'rate_limit_channel_threshold',
    RateLimitChannelWindow: 'rate_limit_channel_window',
    RateLimitChannelCooldown: 'rate_limit_channel_cooldown',
    ...
    RequestFilterEnabled: 'request_filter_enabled',
    RequestFilterKeywords: 'request_filter_keywords',
    RequestFilterErrorMessage: 'request_filter_error_message',
    LogLevel: 'log_level',
